...
SwaggerEditor.controller('MainCtrl', function MainCtrl(
  ...
  Editor, Storage, FileLoader, Analytics, defaults, saveOptionService) {
  $scope.saveOptionService = saveOptionService;
  saveOptionService.getServices().then(function(data){
    $scope.saveOptionService.services = data;
    console.log(data)
  })
